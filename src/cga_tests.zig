...
const cga = @import("geom.zig").cga;

const mult = cga.mult;
const add = cga.add;
const expectApproxEqualIgnoreNorm = cga.expectApproxEqualIgnoreNorm;
const point = cga.point;
const orhogonalProjection = cga.orhogonalProjection;
const sandwichProduct = cga.sandwichProduct;
const regressiveProduct = cga.regressiveProduct;
const equal = cga.equal;
const RegressiveProduct = cga.RegressiveProduct;
const outerProduct = cga.outerProduct;
const OuterProduct = cga.OuterProduct;
const Product = cga.Product;
const innerProduct = cga.innerProduct;
const InnerProduct = cga.InnerProduct;
const iDual = cga.iDual;
const dual = cga.dual;
const DualWithBasis = cga.DualWithBasis;
const xorBlade = cga.xorBlade;
const iNorm = cga.iNorm;
const norm = cga.norm;
const reverse = cga.reverse;
const involute = cga.involute;
const reduce = cga.reduce;
const expectEqual = cga.expectEqual;
const geometricProduct = cga.geometricProduct;
const normalized = cga.normalized;
const expectApproxEqualRel = cga.expectApproxEqualRel;
const sqrt = cga.sqrt;
const GeometricProduct = cga.GeometricProduct;
const collapseBlade = cga.collapseBlade;
const same = cga.same;
const Basis = cga.Basis;
const sameSign = cga.sameSign;
const getFieldNameFromBlade = cga.getFieldNameFromBlade;
const primitive = @import("geom.zig").cga_primitive;
